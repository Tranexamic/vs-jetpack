...
def get_field_difference(clip: vs.VideoNode, tff: FieldBasedLike | bool | None = None) -> vs.VideoNode:
...
def weave(clip: vs.VideoNode, tff: FieldBasedLike | bool | None = None) -> vs.VideoNode:
...
def reinterlace(clip: vs.VideoNode, tff: FieldBasedLike | bool | None = None) -> vs.VideoNode:
